...
In order to use OAuth option, you need **Client ID** and **Client Secret**. If you don’t have them yet, go to Github page and go to **Setting** page. Then **Oauth Applications** and **Register a new Application** say **Rstudio Shiny Contest**

[More Detailed Explanation to Generte Keys at this Link](https://blog.exploratory.io/extract-data-from-private-github-repository-with-rest-api-db804fa43d84)

Once you have the keys put them in **global.R** of this Shiny App and make sure you have active internet connection and you're all set to run **GitDiscoverer**.
